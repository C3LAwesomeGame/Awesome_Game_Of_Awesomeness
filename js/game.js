...
var story = [
    ...
    "Always look on the bright side of life! *whistle whistle*", "You hop on you imaginary steed, -Ride on Steve, ride on!!!",
    "You start to think of your' quest *scratch head*", "Go for the eye's, go, go for the eye's! \n*cough*\n sorry wrong adventure",
    "This night is the night, that is at least what you think when you talked to the forest-nymph! \n I'm so gonna wham bam, and then i will thank the mam!",
    ...
    "*playing a Metallica jingle with your trusty old ukulele* \n'Fortune, fame, mirror vain, gone insane but the memory remains'"
];
